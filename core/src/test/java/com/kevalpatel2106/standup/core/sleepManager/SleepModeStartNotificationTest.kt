...
class SleepModeStartNotificationTest {
    ...
    fun setUp() {
        ...
        Mockito.`when`(context.getString(R.string.sleep_notification_title)).thenReturn(TEST_TITLE_STRING)
        Mockito.`when`(context.getString(R.string.sleep_notification_message)).thenReturn(TEST_MESSAGE_STRING)

        notification = SleepModeStartNotification.buildNotification(context)
    }
