...
class ReportIssueActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submit_issue_btn.setOnClickListener {
        ...
        findViewById<BaseButton>(R.id.btn_prefer_emailing_us).setOnClickListener {
            CommonUtils.sendEmail(this@ReportIssueActivity,
