...
internal object TestNotification3 {
    private val NOTIFICATION_ID = 7897
    ...
    internal fun buildNotification(context: Context): Notification {
        val builder = NotificationCompat.Builder(context)
                ...
                .setContentTitle("User is sitting")
                .setContentText("User is sitting")
                .setPriority(NotificationCompat.PRIORITY_HIGH)
                .setTicker("User is sitting")
                .setAutoCancel(true)
