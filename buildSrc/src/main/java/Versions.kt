 ...
 * Version number for the dependencies listed in [Deps].
 *
...
internal object Versions {
    ...
    const val buildPlugin = "3.1.0-rc02"

    //Libs
    const val junit = "4.12"
    const val multidex = "1.0.3"
    const val archComponent = "1.1.0"
