...
class LoginViewModelSignUpTest {
    ...
    fun checkEmailValidation() {
        ...
        Assert.assertFalse(loginViewModel.isFacebookLoginProgress.value!!)
        Assert.assertFalse(loginViewModel.blockUi.value!!)
        Assert.assertEquals(loginViewModel.mEmailError.value!!.errorMessageRes, com.standup.R.string.error_login_invalid_email)
    ...
    fun checkNameValidation() {
        ...
        Assert.assertEquals(loginViewModel.mNameError.value!!.errorMessageRes, com.standup.R.string.error_login_invalid_name)
    }
    ...
    fun checkPasswordValidation() {
        ...
        Assert.assertFalse(loginViewModel.blockUi.value!!)
        Assert.assertNull(loginViewModel.mEmailError.value)
        Assert.assertEquals(loginViewModel.mPasswordError.value!!.errorMessageRes, com.standup.R.string.error_login_invalid_password)
        Assert.assertNull(loginViewModel.mNameError.value)
    }
    ...
    fun checkPasswordsDidNotMatch() {
        ...
        Assert.assertFalse(loginViewModel.blockUi.value!!)
        Assert.assertNull(loginViewModel.mEmailError.value)
        Assert.assertEquals(loginViewModel.mPasswordError.value!!.errorMessageRes, com.standup.R.string.login_error_password_did_not_match)
        Assert.assertNull(loginViewModel.mNameError.value)
    }
